...
<%@ page import="java.util.*" %>
 <script type="text/javascript">
		...
		function updateTipo(id){
			...
			translator.onUpdate('tipoVacuna',id);
		}
...
<div class="container_12">
	...
	<div class="grid_12">
		<h1>Tipos de Vacunas</h1>
		<p>Desde aqui controle los tipos de vacunas</p>
	</div>
	<div class="grid_12">
		<div class="block-border" id="tab-panel-1">
			...
			<div class="block-content tab-container">
				<div id="tab-1" class="tab-content">
					...
					<table id="tipoVacuna" class="table active-table">
					<thead>
						<tr>
				...
				<div id="new" class="tab-content">
					<%@include file="forms/tipoVacunaForm.jsp" %>
