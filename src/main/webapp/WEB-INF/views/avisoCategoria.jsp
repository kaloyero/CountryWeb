...
<%@ page import="java.util.*" %>
 <script type="text/javascript">
		...
		function updateTipo(id){
			...
			translator.onUpdate('avisoCategoria',id);
		}
...
<div class="container_12">
	...
	<div class="grid_12">
		<h1>Categorias de Avisos</h1>
		<p>Desde aqui controle las categorias de los avisos</p>
	</div>
	<div class="grid_12">
		<div class="block-border" id="tab-panel-1">
			...
			<div class="block-content tab-container">
				<div id="tab-1" class="tab-content">
					...
					<table id="avsioCategoria" class="table active-table">
					<thead>
						<tr>
