...
<div id="reclamo_nuevo" class="formulario">
					...
					<div id="content">
						<div class="inner content-inner clearfix">
							...
							<form:form commandName="AVISO" class="formulario form-validate">
							
								<div class="componentheading">Nuevo Aviso</div>
								<div id="k2Container" class="k2AccountPage">
									...
									<div class="wcgroup">
										...
										<div class="wcontrols">
										<form:input path="titulo" size="40" class="inputbox required validate-email" maxlength="100" aria-required="true" required="required"/>
										</div>
									</div>
									<div class="wcgroup">
										<label class="wlabel" id="namemsg" for="name">Importe</label>
										<div class="wcontrols">
										<form:input path="importe" size="40" class="inputbox required validate-email" maxlength="100" aria-required="true" required="required"/>
										</div>
									</div>
									<div class="wcgroup">
									...
									<!-- K2 attached fields -->
									<div class="wcgroup">
										<label class="wlabel" id="descriptionmsg" for="description">De que se trata tu Aviso?</label>
										<div class="wcontrols">
										<form:textarea path="cuerpo"  rows="3" cols="20" style="width: 100%; height: 250px;" class="mce_editable" aria-hidden="true" />
									...
									<div class="k2AccountPageUpdate">
										<input type="button" class="button" value="Crear Aviso" onclick="translator.onSubmit('aviso');">
									</div>
								</div>
							...
							<div class="col aside-col aside-col-3 masonry-brick" style="position: absolute; top: 175px; left: 10px; width: 216px;">
								<div class="moduletable moduletable bg_yellow" id="Mod39">
									<div class="inner moduletable-inner clearfix">
										...
										<div class="box-ct clearfix">
											<p>Tenes 2 avisos creados en el mes</p>
										</div>
									</div>
									&nbsp; &nbsp;
								</div>
