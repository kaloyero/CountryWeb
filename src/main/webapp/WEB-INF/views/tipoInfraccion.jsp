...
<div class="container_12">
	...
	<div class="grid_12">
		<h1>Tipos de Infraccion</h1>
		<p>Desde aqui controle los tipos de infraccion</p>
	</div>
	<div class="grid_12">
		<div class="block-border" id="tab-panel-1">
			...
			<div class="block-content tab-container">
				<div id="tab-1" class="tab-content">
					...
					<table id="tipoInfraccion" class="table active-table">
					<thead>
						<tr>
				...
				<div id="new" class="tab-content">
					<%@include file="forms/tipoInfraccionForm.jsp" %>
