 ...
 */
@Controller
@RequestMapping(value = "/tipoAutorizacion")
public class TipoAutorizacionController {

	@Autowired
	private TypeAuthorizationManager typeAuthorizationManager;
	
	@RequestMapping(value = "/create",method = RequestMethod.GET)
	public String showForm(ModelMap model) {
		TipoForm tipo = new TipoForm();
		model.addAttribute("TIPO", tipo);
		model.addAttribute("accion", "tipoAutorizacion");
	...
	public String processForm(
		...
		typeAuthorizationManager.save(TipoMapper.getTipoAutorizacion(tipoForm));
				return "success";
	...
	public String load(ModelMap model,@PathVariable int id) throws ParseException {
		...
		TipoAutorizacion type =typeAuthorizationManager.findById(id);
	...
	public String update(@ModelAttribute(value = "TIPO") TipoForm tipoForm,@PathVariable int id,
			BindingResult result) throws ParseException {
		typeAuthorizationManager.update(TipoMapper.getTipoAutorizacion(tipoForm));
		return "success";
	...
	public  @ResponseBody DataTable getUserInJSON()  {
           ...
           DataTable dataTable=new DataTable();
			...
			for (TipoAutorizacion tipo : typeAuthorizationManager.listAll()) {
