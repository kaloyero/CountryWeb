 ...
 */
@Controller
@RequestMapping(value = "/mensajeCategoria")
public class MensajeCategoriaController {
	...
	public String showForm(ModelMap model) {
		...
		model.addAttribute("accion", "mensajeCategoria");
	...
	public String processForm(
		...
		messageCategoryManager.save(TipoMapper.getMensajeCategoria(tipoForm));
				return "success";
