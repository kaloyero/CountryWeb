...
public class TipoVehiculosController {
	...
	public String showForm(ModelMap model) {
		...
		model.addAttribute("accion", "tipoVehiculo");
		return "tipoVehiculo";
	}
	...
	public String processForm(
		...
		typeVehicleManager.save(TipoMapper.getTipoVehiculo(tipoForm));
				return "success";
	...
	public String load(ModelMap model,@PathVariable int id) throws ParseException {
		...
		TipoVehiculo type =typeVehicleManager.findById(id);
	...
	public String update(@ModelAttribute(value = "TIPO") TipoForm tipoForm,@PathVariable int id,
			BindingResult result) throws ParseException {
		typeVehicleManager.update(TipoMapper.getTipoVehiculo(tipoForm));
		return "success";
	...
	public  @ResponseBody DataTable getUserInJSON()  {
           ...
           DataTable dataTable=new DataTable();
			...
			for (TipoVehiculo tipo : typeVehicleManager.listAll()) {
